    ...
    <section id="contacto" className="bg-background py-24 border-t border-primary/5">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex items-center justify-center gap-2 mt-6">
          <span className="text-[#25D366]"><WaIcon size={14} /></span>
          <a
            href={whatsapp}
            target="_blank"
            rel="noopener noreferrer"
            className="font-inter text-sm text-app-text/40 hover:text-[#25D366] transition-colors duration-200"
          >
            +54 9 11 3612-5857
          </a>
        </div>

        <p className="font-inter text-xs text-app-text/30 mt-2">
          {contacto.note}
        </p>
