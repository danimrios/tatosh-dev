...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-200 bg-white text-gray-800 font-grotesk font-semibold text-sm px-4 py-2 rounded-full shadow-lg whitespace-nowrap pointer-events-none">
        ¿Hablamos?
      </span>
